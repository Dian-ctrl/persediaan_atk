    ...
    <div class="card-body-biru">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-4">
                ...
                <a href="{{ route('pengguna.transaksi-keluar.index') }}" class="btn btn-secondary btn-sm">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card-biru">
    <div class="card-header-biru">
        <div class="title"><i class="bi bi-box-arrow-up-right"></i> Barang Keluar ({{ $data->total() }})</div>
        <a href="{{ route('pengguna.transaksi-keluar.create') }}" class="btn btn-biru">
        ...
        <table class="table tbl-biru">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:.8rem;color:#888">{{ $d->penerima ?? '-' }}</td>
                </tr>
                @empty
                <tr><td colspan="8" class="text-center py-4 text-muted">Belum ada data barang keluar</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
